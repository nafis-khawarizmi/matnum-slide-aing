...
\begin{document}
    ...
    \begin{frame}{Metode Beda Hingga: Konstruksi}
        ...
        \begin{align*}
            -\frac{d}{dx}\left(p(x)\frac{du}{dx}\right) + &q(x)\frac{du}{dx} + r(x)u = f(x), \, a<x<b, \\
            &u(a) = A, u(b) = B.
        \end{align*}
        Masalah ini bisa ditulis sebagai
        ...
        \end{align}
        yang disebut sebagai \emph{prinsip Rayleigh-Ritz}.
    \end{frame}
    \begin{frame}{Metode Beda Hingga: Konstruksi}
       Perhatikan bahwa
       \begin{align*}
       ...
       \end{align*}
       adalah form bilinear yang simetrik. Akibatnya, kita bisa tulis \eqref{weakform} sebagai
       ...
       \begin{theorem}[Prinsip Galerkin]
           ...
           \end{align}
       \end{theorem}
       Buktinya dapat dibaca di \cite{Süli2003Introduction}. \newline
       Tentunya mencari solusi untuk masalah \eqref{weakform} juga sulit. Maka, kita bisa gunakan prinsip Galerkin yang sudah didefinisikan sebelumnya.
    \end{frame}
    \begin{frame}{Metode Beda Hingga: Konstruksi}
