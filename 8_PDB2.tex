...
\begin{document}
    ...
    \begin{frame}{Metode Beda Hingga: Konstruksi}
        ...
        \begin{align}\label{weakform}
            \mathcal{I}(w) = \frac{1}{2}\int_a^b (p(x)(w')^2+r(x)w^2) dx - \int_a^b f(x)w(x)dx
        \end{align}
        dengan $w\in H^1_E(a,b)$, dan kita tinjau masalah optimisasi
        \begin{align}\label{rayleighritz}
            \min_{w\in H^1_E(a,b)} \mathcal{I}(w).
        \end{align}
    ...
    \begin{frame}{Metode Beda Hingga: Konstruksi}
       ...
       \begin{align}
           \mathcal{I}(w) = \frac{1}{2}\mathcal{A}(w,w) - \langle f,w\rangle_{L^2(a,b)}
       \end{align}
    \end{frame}
\end{document}
